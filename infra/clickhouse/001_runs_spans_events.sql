...
(
    ...
    audio_input_tokens Nullable(UInt64) COMMENT 'Runtime-specific audio input token rollup for multimodal pricing.',
    audio_output_tokens Nullable(UInt64) COMMENT 'Runtime-specific audio output token rollup for multimodal pricing.',
    total_tokens Nullable(UInt64) COMMENT 'Usage.total_tokens rollup.',
    batch_discount_multiplier Nullable(Decimal(9, 6)) COMMENT 'Runtime/cost-engine multiplier used when batch pricing applies.',
...
(
    ...
    audio_input_tokens Nullable(UInt64) COMMENT 'Runtime-specific audio input tokens for multimodal model_call spans.',
    audio_output_tokens Nullable(UInt64) COMMENT 'Runtime-specific audio output tokens for multimodal model_call spans.',
