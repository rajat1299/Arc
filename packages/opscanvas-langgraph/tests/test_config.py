...
from opscanvas_langgraph import OpsCanvasConfig
...
def test_config_treats_empty_optional_values_as_missing() -> None:
    config = OpsCanvasConfig.from_env(
        {
            "OPSCANVAS_ENDPOINT": "",
            "OPSCANVAS_API_KEY": "",
...
def test_importing_package_without_langgraph_works() -> None:
